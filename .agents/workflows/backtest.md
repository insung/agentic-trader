...
먼저 백테스트에 사용할 과거 캔들 데이터를 MT5에서 내려받습니다.
- **명령어**: `make backtest-fetch SYMBOL=종목 DAYS=일수`
- **예시**: `make backtest-fetch SYMBOL=EURUSD DAYS=30`
- **결과**: `backtests/data/` 디렉토리에 CSV 파일이 생성됩니다.
