...
from backend.features.trading.adapters.mt5_account import get_deals_history, get_open_positions
from backend.features.trading.adapters.mt5_market_data import get_current_price
